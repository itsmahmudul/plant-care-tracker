...
const PlantCard = ({ plant }) => {
    ...
    return (
        <div
            className={`
                rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 p-4 w-full max-w-sm flex flex-col justify-between
                ${darkMode
        ...
        >
            ...
            <Link to={`/plant-details/${plant._id}`}>
                <button
                    className={`
                        mt-6 w-full cursor-pointer py-2 px-4 rounded-xl text-sm font-semibold transition-all duration-300 ease-in-out shadow-md hover:shadow-lg
                        ${darkMode
